...
public class ApiController {
    ...
    @ApiImplicitParams({
                    ...
                    @ApiImplicitParam(name = "x", value = "y 값", required = true, dataType = "int", paramType = "query")
    })
    @GetMapping("/plus/{x}")
    ...
    @ApiResponse(code = 502, message = "사용자 나이 10살 이하")
    @ApiOperation(value = "사용자 이름과 나이를 return하는 메서드")
    @GetMapping("/user")
